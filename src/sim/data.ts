...
export const SIM_VERSION = 20; // v20: truck-launched Shahed — a MOVE order now drives the parked launcher (truck+drone) on the ground; only an attack target makes it take off
