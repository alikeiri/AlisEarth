...
class AudioMan {
  ...
  private trackSrc: Record<string, string> = { iron: './audio/iron_directive.mp3', golden: './audio/golden_dreams.mp3' };
  ...
  static ENABLED = ['iron', 'golden', 'off'];
  private static PLAYLIST = ['iron', 'golden'];
